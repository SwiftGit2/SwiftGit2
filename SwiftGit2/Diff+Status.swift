...
public extension Diff.Delta {
	...
	func diff(repo: Repository) -> Result<Diff, NSError> {
		...
		guard let oldFile = self.oldFile else { return .failure(NSError(gitError: 0, pointOfFailure: "no old file")) }
		guard let newFile = self.newFile else { return .failure(NSError(gitError: 0, pointOfFailure: "no new file")) }
		guard case let .success(OldBlob) = repo.object(oldFile.oid).map({ $0 as? Blob })  else { return .failure(NSError(gitError: 0, pointOfFailure: "no object for old file")) }
		guard case let .success(NewBlob) = repo.object(newFile.oid).map({ $0 as? Blob })  else { return .failure(NSError(gitError: 0, pointOfFailure: "no object for new file")) }
...
//		}
		...
		//git_diff_blobs(oldBlob.pointer, nil, newBlob.pointer, nil, optionsPointer, <#T##file_cb: git_diff_file_cb!##git_diff_file_cb!##(UnsafePointer<git_diff_delta>?, Float, UnsafeMutableRawPointer?) -> Int32#>, <#T##binary_cb: git_diff_binary_cb!##git_diff_binary_cb!##(UnsafePointer<git_diff_delta>?, UnsafePointer<git_diff_binary>?, UnsafeMutableRawPointer?) -> Int32#>, <#T##hunk_cb: git_diff_hunk_cb!##git_diff_hunk_cb!##(UnsafePointer<git_diff_delta>?, UnsafePointer<git_diff_hunk>?, UnsafeMutableRawPointer?) -> Int32#>, <#T##line_cb: git_diff_line_cb!##git_diff_line_cb!##(UnsafePointer<git_diff_delta>?, UnsafePointer<git_diff_hunk>?, UnsafePointer<git_diff_line>?, UnsafeMutableRawPointer?) -> Int32#>, <#T##payload: UnsafeMutableRawPointer!##UnsafeMutableRawPointer!#>)
		
		//git_diff_blobs(oldBlob.p, <#T##old_as_path: UnsafePointer<Int8>!##UnsafePointer<Int8>!#>, <#T##new_blob: OpaquePointer!##OpaquePointer!#>, <#T##new_as_path: UnsafePointer<Int8>!##UnsafePointer<Int8>!#>, <#T##options: UnsafePointer<git_diff_options>!##UnsafePointer<git_diff_options>!#>, <#T##file_cb: git_diff_file_cb!##git_diff_file_cb!##(UnsafePointer<git_diff_delta>?, Float, UnsafeMutableRawPointer?) -> Int32#>, <#T##binary_cb: git_diff_binary_cb!##git_diff_binary_cb!##(UnsafePointer<git_diff_delta>?, UnsafePointer<git_diff_binary>?, UnsafeMutableRawPointer?) -> Int32#>, <#T##hunk_cb: git_diff_hunk_cb!##git_diff_hunk_cb!##(UnsafePointer<git_diff_delta>?, UnsafePointer<git_diff_hunk>?, UnsafeMutableRawPointer?) -> Int32#>, <#T##line_cb: git_diff_line_cb!##git_diff_line_cb!##(UnsafePointer<git_diff_delta>?, UnsafePointer<git_diff_hunk>?, UnsafePointer<git_diff_line>?, UnsafeMutableRawPointer?) -> Int32#>, <#T##payload: UnsafeMutableRawPointer!##UnsafeMutableRawPointer!#>)

		
//		if case let .success(blob) = repo.object(oldFile.oid).map({ $0 as? Blob }) {
//			if let blob = blob {
//				print(blob)
//
